...
class Freshdesk {
	 ...
	 * @category Groups
	 *
	 * @param  {Number}                             id      Unique ID of the Group
	 * @param  {Freshdesk.requestCallback}          cb      Callback function {@link Freshdesk.requestCallback}
	 */
	getGroup(id, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/groups/${id}`, null, null, cb)
	}

	/**
	 * List All Groups.
	 *
	 * @see {@link https://developers.freshdesk.com/api/#list_all_groups}
	 *
	 * @category Groups
	 *
	 * @param  {Freshdesk.requestCallback}          cb      Callback function {@link Freshdesk.requestCallback}
	...
	listAllGroups(params, cb) {
		makeRequest('GET', this._auth, `${this.baseUrl}/api/v2/groups`, params, null, cb)
	}
